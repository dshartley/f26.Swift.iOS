...
public class AwardSOAPWebServiceModelAccessStrategy: ModelAccessStrategyBase {
	...
	public func selectDummy(byCategory category: Int, year: Int, collection: ProtocolModelItemCollection, oncomplete completionHandler:@escaping ([Any]?, ProtocolModelItemCollection?, Error?) -> Void) {
...
extension AwardSOAPWebServiceModelAccessStrategy: ProtocolAwardModelAccessStrategy {
	...
	public func select(byCategory category: Int, year: Int, collection: ProtocolModelItemCollection, oncomplete completionHandler:@escaping ([Any]?, ProtocolModelItemCollection?, Error?) -> Void) {
		...
		let soapMessage: 			String = String(format: soapMessageTemplate, String(category), String(year))
