...
class AppDelegate: UIResponder {
	...
	lazy var persistentContainer: NSPersistentContainer = {
		...
		*/
		let container = NSPersistentContainer(name: "f26")
...
// MARK: - Extension PushNotifications
...
// MARK: - Extension UNUserNotificationCenterDelegate, MessagingDelegate
...
extension AppDelegate {
	...
	fileprivate func setupAuthenticationManager() {
		...
		let authenticationStrategy: ProtocolAuthenticationStrategy = BasicCodeAuthenticationStrategy()
